...
const CardTrackingSystem = () => {
  ...
  // UPDATED FORM DATA WITH ALL THREE DATE FIELDS
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // RESET FORM WITH ALL DATE FIELDS
      setFormData({
        date_purchased: '',
        source: 'eBay',
        player_card_name: '',
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    <thead style={{ backgroundColor: '#f9fafb' }}>
                      <tr>
                        ...
                        <th style={{ textAlign: 'left', padding: '12px' }}>Purchase Date</th>
                        <th style={{ textAlign: 'left', padding: '12px' }}>Graded Date</th>
                        <th style={{ textAlign: 'left', padding: '12px' }}>Sold Date</th>
                    ...
                    <tbody>
                      {filteredCards.map(card => (
                        <tr key={card.id} style={{ borderBottom: '1px solid #f3f4f6' }}>
                          ...
                          <td style={{ padding: '12px', fontSize: '12px' }}>{formatDate(card.date_purchased)}</td>
                          <td style={{ padding: '12px', fontSize: '12px' }}>{formatDate(card.graded_date)}</td>
                          <td style={{ padding: '12px', fontSize: '12px' }}>{formatDate(card.date_sold)}</td>
